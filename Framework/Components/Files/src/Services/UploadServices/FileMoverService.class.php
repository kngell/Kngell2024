...
// Assuming the following classes/interfaces exist in your system:
...
class FileMoverService
{
    ...
    private function performMove(
        ...
        // Process file if processor is available and supports this file type
        ...
        // Default move operation for uploaded files
        if (!move_uploaded_file($upload->getPathname(), $targetPath)) {
            throw new FileException("Failed to move uploaded file to: {$targetPath}");
        }
