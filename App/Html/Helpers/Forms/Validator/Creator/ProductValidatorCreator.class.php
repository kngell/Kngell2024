...
class ProductValidatorCreator extends AbstractValidatorCreator
{
    ...
    public function create(
        ...
        return match ($ruleName) {
            ...
            'required_if' => new RequiredIfValidator($errorParams, $display, $inputValue, $ruleValue, $this->inputFields, $fieldName),
            ...
            'lte' => new LteValidator($errorParams, $display, $inputValue, $ruleValue, $this->inputFields, $fieldName),
            'gte' => new GteValidator($errorParams, $display, $inputValue, $ruleValue, $this->inputFields, $fieldName),
            ...
            'unique_in_array' => new UniqueInArrayValidator($errorParams, $display, $inputValue, $ruleValue, $this->inputFields, $fieldName),
            'integer' => new IntegerValidator($errorParams, $display, $inputValue),
