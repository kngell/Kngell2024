...
class ProductSectionServiceProvider
{
    ...
    public function registerSections(FormSectionManager $manager, HtmlBuilder $form): void
    {
        $sections = [
            ...
            'brand' => new BrandSection($form, $this->brandService),
            'category' => new CategorySection($form, $this->categoryService),
            'product-status' => new ProductStatusSection($form, $this->productStatusService),
        ];
