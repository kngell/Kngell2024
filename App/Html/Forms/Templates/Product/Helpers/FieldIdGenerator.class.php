...
class FieldIdGenerator
{
    ...
    private function ensureUniqueId(string $baseId, array $field): string
    {
        ...
        if (isset($field['_globalIndex'])) {
            return $baseId . '_' . $field['_globalIndex'];
        }
        ...
        return $baseId . '_' . $fallbackCounters[$baseId];
    }

    private function exists(string $baseId): bool
    {
        return in_array($baseId, $this->idCache, true);
    }
}