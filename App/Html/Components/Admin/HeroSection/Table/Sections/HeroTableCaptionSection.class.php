...
class HeroTableCaptionSection extends AbstractBaseHtmlSection implements TableSectionInterface
{
    private const string CAPTION_TEXT = 'This table lists Hero entities for the frontend hero section';
