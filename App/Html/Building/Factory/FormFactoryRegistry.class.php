...
class FormFactoryRegistry
{
    ...
    public function findFactoryClassForActionAndRoute(string $action): ?string
    {
    ...
    public function getFactory(string $action): ?FormFactoryInterface
    {
        $factoryClass = $this->findFactoryClassForActionAndRoute($action);
