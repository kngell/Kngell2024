...
class HeaderTopSection extends AbstractBaseHtmlSection
{
    ...
    {
        return PageWrapperSection::HEADER_TOP->value;
    }
    ...
    public function getSectionsCustomLayout(array $sections): ?AbstractHtmlComponent
    {
        ...
        return $html->tag('div')->class('container', 'menu')->add(
            ...$sections,
        );
    }
    ...
    private function logMenu(): AbstractHtmlComponent
    {
        $html = $this->htmlBuilder;
    ...
    private function actionsMenu(?array $accountConfig): AbstractHtmlComponent
    {
        ...
        // Cart link
        $cartLink = (new UserCartComponent(
            $this->iconBuilder,
            $this->htmlBuilder,
        ))->build(['id']);
