...
class ContentBlockProductRelationshipSection extends BaseFieldSection
{
    ...
    public function getConfig(array $formValues = []): array|AbstractHtmlComponent
    {
        ...
        $label = $hasValue ? $formValues['product_name'] ?? null : 'Select Product...';
    ...
    {
        return BlockTypeSection::PRODUCT->value;
    }
    ...
    private function extractProductDataFromFormValues(): ?array
    {
        ...
        $description = $this->formValues['banner_description'] ??
