...
class DropzoneRenderer
{
    ...
    public function render(array $field, FormBuilder $form, AbstractForm $formInstance, int $globalIndex, PageConfig|FormConfig|null $config): AbstractHtmlComponent
    {
    ...
    private function getProcessedFiles(array $field, AbstractForm $formInstance): array
    {
        ...
        // Only remove the trailing [] if it exists at the END of the string
        $fieldName = $this->getBaseFieldName($field['name']);
