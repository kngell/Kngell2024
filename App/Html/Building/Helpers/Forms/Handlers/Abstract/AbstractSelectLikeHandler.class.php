...
abstract class AbstractSelectLikeHandler extends AbstractBaseFieldHandler implements FieldHandlerInterface
{
    ...
    protected function getSelectedValue(array $field, AbstractForm $formInstance): null|string|array
    {
