...
class CurrencyFieldHandler extends AbstractBaseFieldHandler implements FieldHandlerInterface
{
    ...
    private function buildCurrencyOptions(array $field, FormBuilder $form, AbstractForm $formInstance): array
    {
        ...
        foreach ($currencies as $value => $label) {
            $isSelected = $this->shouldSelectCurrency($currentValue, (string) $defaultValue, (string) $value);
    ...
    private function shouldSelectCurrency(?string $currentValue = null, ?string $defaultValue = null, ?string $optionValue = null): bool
    {
