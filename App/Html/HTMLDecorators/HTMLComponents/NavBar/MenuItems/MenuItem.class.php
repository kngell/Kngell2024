...
class MenuItem implements MenuItemInterface
{
    ...
    {
        $this->acl = json_decode(file_get_contents(FileSearchManager::get(APP, 'acl.json')), true);
        $this->menu = json_decode(file_get_contents(FileSearchManager::get(APP, 'menu_acl.json')), true);
