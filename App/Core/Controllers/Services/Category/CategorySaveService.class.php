...
class CategorySaveService extends AbstractSaveService
{
    ...
    {
        return new CategoryEvent($eventData);
    }

    public function getEditUrl(int $entityId): string
    {
        return "/admin/category-page/{$entityId}/edit";
    }
    ...
    {
        return '/admin/category-page/add';
    }
}