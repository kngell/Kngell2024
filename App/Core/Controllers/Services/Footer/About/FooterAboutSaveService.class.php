...
class FooterAboutSaveService extends AbstractSaveService
{
    ...
    {
        return new FooterAboutEvent($eventData);
    }

    public function getEditUrl(int $entityId): string
    {
        return "/admin/footer-about/{$entityId}/edit";
    }
    ...
    public function getSuccessMessage(string $operationType, bool $wasSkipped): string
    {
        return match($operationType) {
            'insert' => 'Footer About has been created successfully',
            'update' => !$wasSkipped
                ? 'Footer About has been updated successfully'
                : 'No changes were made to the Footer Column',
            'delete' => 'Footer About has been deleted successfully',
