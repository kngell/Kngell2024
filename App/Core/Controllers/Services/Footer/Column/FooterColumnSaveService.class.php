...
class FooterColumnSaveService extends AbstractSaveService
{
    ...
    {
        return new FooterMenuColumEvent($eventData);
    }

    public function getEditUrl(int $entityId): string
    {
        return "/admin/footer-column/{$entityId}/edit";
    }
    ...
    {
        return FooterMenuColumEvent::class;
    }
    ...
    public function getSuccessMessage(string $operationType, bool $wasSkipped): string
    {
        return match($operationType) {
            'insert' => 'Footer Column has been created successfully',
            'update' => !$wasSkipped
                ? 'Footer Column has been updated successfully'
                : 'No changes were made to the Footer Column',
            'delete' => 'Footer Column has been deleted successfully',
    ...
    {
        return '/admin/footer-column/add';
    }
}