...
class FooterColumnConfirmDeletionController extends AbstractConfirmDeletionController
{
    public function __construct(
        private FooterColumnDeleteValidator $validator,
    ...
    protected function createDeletionDecorator(array $data): object
    {
        $dto = ConfirmDeletionDTO::fromFlashData(
            flashData: $data,
            label: $this->getLabel(),
            deleteRoute: '/admin/footer-column-confirm-deletion/confirm',
        ...
        return $this->decorate(
            ...
            [
                ...
                'action' => '/admin/footer-column-delete/delete',
