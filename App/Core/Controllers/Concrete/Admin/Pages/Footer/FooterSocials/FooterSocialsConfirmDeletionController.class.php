...
class FooterSocialsConfirmDeletionController extends AbstractConfirmDeletionController
{
    public function __construct(
        private FooterSocialDeleteValidator $validator,
    ...
    protected function createDeletionDecorator(array $data): object
    {
        $dto = ConfirmDeletionDTO::fromFlashData(
            flashData: $data,
            label: $this->getLabel(),
            deleteRoute: '/admin/footer-socials-confirm-deletion/confirm',
        ...
        return $this->decorate(
            ...
            [
                ...
                'action' => '/admin/footer-social-delete/delete',
