...
class ProductShow extends Entity implements TimestampableInterface
{
    ...
    private ?ProductRegionalPrice $productRegionalPrice = null;
     ...
     * @return ProductShow
     */
    public function setAltText(?string $altText): ProductShow
    {
    ...
    /**
     * @param null|ProductStatus $productStatus
     *
     * @return ProductShow
     */
    ...
    /**
     * @return null|ProductRegionalPrice
     */
    ...
    /**
     * @param null|ProductRegionalPrice $productRegionalPrice
     *
     * @return ProductShow
     */
    ...
    /**
     * @param null|StockStatus $stockStatus
     *
     * @return ProductShow
     */
