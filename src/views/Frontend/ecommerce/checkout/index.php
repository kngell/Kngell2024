        ...
        <form class="container checkout-form" id="checkoutForm">
            ...
            <div class="form-step address active" data-step="1">
                <div class="form-step__content">
                                    ...
                                    <div class="address-container">
                                        <div class="address-container--top">
                                            <input type="radio" name="shipping-address" id="input-box__radio-address1"
                                                checked>
                                            <label for="input-box__radio-address1"
                                                class="address-container--top__label">
                                ...
                                <div class="details__addresses--address">
                                    <div class="address-container">
                                        <div class="address-container--top">
                                            ...
                                            <label for="input-box__radio-address2"
                                                class="address-container--top__label">
                                                <span class="text-container">
                                ...
                                <span class="line-and-icon-wrapper">
                                    <span class="icon-container">
                                        <svg class="icon address" aria-label="Plus" role="img">
                                            <use href="<?= $this->asset('img/icons-sprite.svg') ?>#icon-plus-solid">
                                            </use>
                                        </svg>
                                    </span>
                                </span>
                    ...
                    <div class="form-step__cart-summary">
                        ...
                        <div class="shopping-cart__summary--content">
                                ...
                                <div class="subtotal__coupon">
                                    <div class="subtotal__coupon--code">
                                        ...
                                        <div class="discount-box"><input type="text" class="discount-box__input"
                                                id="discount-code" name="discount-code" placeholder="discount code...">
                                        </div>
                                    </div>
                                    <div class="subtotal__coupon--code">
                                        <p class="promo-title">Promo code</p>
                                        <div class="discount-box"><input type="text" class="discount-box__input"
                                                id="promo-code" name="promo-code" placeholder="promo code..."></div>
                                    </div>
                                    <button class="subtotal__coupon--apply" type="button"><span>Apply</span></button>
                                </div>
                            ...
                            <div class="btns"><button class="btn btn-dark" type="button">Proceed to Checkout</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-step summary" data-step="3">
                <div class="form-step__content">
                    <div class="summary__payment-method">
                        ...
                        <div class="payment-details payment-tabs">
                            <div class="payment-details__header">
                                ...
                                <div class="tabs-labels" role="tablist">
                                    ...
                                    <label class="mode" for="tab-paypal-credit" data-mode="paypal-credit"
                                        role="tab">Paypal
                                        Credit</label>
                                </div>
                            </div>
