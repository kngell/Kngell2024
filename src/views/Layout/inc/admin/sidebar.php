   ...
   <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
         ...
         <li class="nav-item dropdown active">
            <a href="#" class="nav-link has-dropdown"><i class="fa-solid fa-hand-point-right"></i><span>Dropdown
                  Items</span></a>
            <ul class="dropdown-menu">
               <li class="active"><a class="nav-link" href=""><i class="fa-solid fa-angle-right"></i>
                     Item
                     1</a>
               </li>
               <li class=""><a class="nav-link" href=""><i class="fa-solid fa-angle-right"></i> Item
                     2</a></li>
            </ul>
         </li>
