            ...
            <div class="row">
                <div class="input-wrapper">
                    ...
                    <div class="input-field">
                        <div class="input-field__body">
                            <div class="input-field__input-container">
                                <input type="text" class="input-field__input" id="bio" placeholder=" " value="John Doe">
                ...
                <div class="textarea-wrapper">
                    ...
                    <div class="input-field">
                        <div class="input-field__body">
                            ...
                            <div class="input-field__input-container">
                                <textarea class="input-field__textarea" id="notes" placeholder=" " rows="3"></textarea>
                ...
                <div class="input-wrapper">
                    ...
                    <div class="input-field">
                        <fieldset class="input-field__fieldset">
                            ...
                            <div class="input-field__radio-options horizontal">
                                ...
                                <label class="input-field__radio">
                                    <input type="radio" name="gender" value="female" class="input-field__radio-input">
                                    <span class="input-field__radio-custom"></span>
                                    <span class="input-field__radio-label">Female</span>
                                </label>

                                <label class="input-field__radio">
                                    <input type="radio" name="gender" value="other" class="input-field__radio-input">
                                    <span class="input-field__radio-custom"></span>
                    ...
                    <div class="input-field is-error">
                        <fieldset class="input-field__fieldset">
                            ...
                            <div class="input-field__radio-options">
                                <label class="input-field__radio">
                                    <input type="radio" name="contact" value="email" class="input-field__radio-input">
                                    <span class="input-field__radio-custom"></span>
                                    <span class="input-field__radio-label">Email</span>
                                </label>

                                <label class="input-field__radio">
                                    <input type="radio" name="contact" value="phone" class="input-field__radio-input">
                                    <span class="input-field__radio-custom"></span>
            ...
            <div class="row">
                <div class="input-wrapper">
                    ...
                    <div class="input-field">
                        <div class="input-field__body">
                            <div class="input-field__input-container">
                                <input type="number" class="input-field__input" id="quantity" placeholder=" " value="1"
                                    min="1" max="99">
            ...
            <div class="row">
                <div class="input-wrapper">
                    ...
                    <div class="input-field input-field--required">
                        <div class="input-field__body">
                            <div class="input-field__input-container">
                                <input type="text" class="input-field__input" id="fullname" placeholder=" " required>
...
<!----------custom--------->
<?= $this->js('js/backend/component/ProductSelector') ?>
