...
<main id="main-site">
   ...
   <div class="k-container" style="border: 2px dashed green">
      ...
      <div class="k-row u-margin-b-20">
         <div class="k-col-6 k-col-md-3 u-margin-b-20 u-margin-b-0-md" style="border: 1px solid red">1
         </div>
         <div class="k-col-6 k-col-md-3 u-margin-b-20 u-margin-b-0-md" style="border: 1px solid blue">2</div>
         <div class="k-col-6 k-col-md-3" style="border: 1px solid green">3</div>
         <div class="k-col-6 k-col-md-3" style="border: 1px solid black">4</div>

         <div class="k-offset-2 k-col-6" style="border: 1px solid blue;padding: 10px;">Hello offset 2</div>
      </div>
