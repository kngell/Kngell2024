(function ($) {
  ...
  $(function () {
    ...
    document
      .querySelectorAll('[data-bs-toggle="tooltip"], [data-toggle="tooltip"]')
      .forEach(function (el) {
    ...
    document
      .querySelectorAll(".notification-toggle, .message-toggle")
      .forEach(function (el) {
    ...
    document
      .querySelectorAll(".alert-dismissible .close")
      .forEach(function (el) {
        el.addEventListener("click", function () {
